...
begin
  ...
  begin
    ...
    case FPosition of
      rhLeft:
        begin
          FTarget.SetBounds(FTarget.Left + DeltaX, FTarget.Top, FTarget.Width - DeltaX, FTarget.Height);
        end;
      rhRight:
        begin
          FTarget.Width := FTarget.Width + DeltaX;
        end;
      rhTop:
        begin
          FTarget.SetBounds(FTarget.Left, FTarget.Top + DeltaY, FTarget.Width, FTarget.Height - DeltaY);
        end;
      rhBottom:
        begin
          FTarget.Height := FTarget.Height + DeltaY;
        end;
    end;
